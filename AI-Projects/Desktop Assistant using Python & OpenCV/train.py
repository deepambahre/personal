...
message = tk.Label(window, text="Desktop Assistant and Attendance System" ,bg="#8EB7FC"  ,fg="white"  ,width=50  ,height=2,font=('Helvetica', 30, 'italic bold ')) 
...
txt = tk.Entry(window,width=30  ,bg="#CAC9C8" ,fg="Blue",font=('times', 15, ' bold '))
...
txt2 = tk.Entry(window,width=30  ,bg="#CAC9C8"  ,fg="Blue",font=('times', 15, ' bold ')  )
...
message2 = tk.Label(window, text="" ,fg="Green"   ,bg="#CAC9C8",activeforeground = "green",width=30  ,height=5  ,font=('Helvetica', 15, ' bold ')) 
