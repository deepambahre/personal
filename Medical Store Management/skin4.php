...
<html>
<head>
<link rel="stylesheet" type="text/css" href="magnifierskin4.css">
<script type="text/javascript" src="magnifierskin4.js"></script>
<style>
ul {
...
<h3 style="color:#F0E68C; text-align:center;">PRODUCT INGREDIENTS:</h3>
<p style="color:#F0E68C; font-size:16px;text-align: left;width: 70%;margin-left: 296px;">Wheat Flour, Dried Milk Skimmed, Caramel, Sucrose,Palm Olein,Date Syrup, Low Erucic Acid,                                                              
                                      Rapeseed Oil,Coconut Oil,Maltodextrin, Vanillin,Corn Starch, Sunflower Oil, Sugar Syrup,
                                      Bifidus Culture, Minerals& Vitamins.</p>
<h3 style="color:#F0E68C; text-align:center;font-size:20px;">COUNTRIES AVAILABLE IN:</h3>									  
<h3>  
<p style="color:#F0E68C; font-size:16px;text-align: left;width: 70%;margin-left: 296px;">KSA, UAE, Kuwait, Lebanon, Jordan, Qatar,Bahrain,Oman, Iran & Iraq.</p>
